...
<header>
    ...
    <a href="survey.php" class="surveyLink">Take our survey!</a>
</header>
<section>
    <!-- I have included extra images in the images folder, if you want to use more. Please delete any you don't use -->
    <h1 class="title">Glass Harmonica</h1>
    <div class="right_F">
    <img src="images/glass-harmonica-1.jpg" alt="harmonica image" class="instrument">
